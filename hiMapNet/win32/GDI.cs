...
namespace Win32
{
	...
	public abstract class GDI
	{
        ...
        [DllImport("gdi32")]
        public static extern int Polyline(HDC hdc, ref System.Drawing.Point lpPoint, int nCount);
		...
		[DllImport("gdi32")] public static extern int SetBkColor(HDC hdc, int crColor);
		...
		[DllImport("gdi32")] public static extern int TextOut(HDC hdc, int x, int y, string lpString, int nCount);
